...
class RNNDecoderBase(nn.Module):
    ...
    def forward(self, tgt, memory_bank, state, memory_lengths=None, attn_overwrite=[]):
        """
        Args:
        ...
        return decoder_outputs, state, attns, weighted_context
...
class StdRNNDecoder(RNNDecoderBase):
    ...
    """
    def _run_forward_pass(self, tgt, memory_bank, state, memory_lengths=None, attn_overwrite=[]):
        """
...
class InputFeedRNNDecoder(RNNDecoderBase):
    ...
    def _run_forward_pass(self, tgt, memory_bank, state, memory_lengths=None, attn_overwrite=[]):
        ...
        # Return result.
        return hidden, decoder_outputs, attns, coverage, contexts
...
class NMTModel(nn.Module):
    ...
    def forward(self, src, tgt, lengths, dec_state=None):
        ...
        decoder_outputs, dec_state, attns, weighted_context = self.decoder(
            tgt, memory_bank,
        ...
        if self.multigpu:
            ...
            dec_state = None
            attns = None
        return decoder_outputs, attns, dec_state, weighted_context, context
