...
class ONMTmodelAPI():
    ...
    def update_translator(self, options={'k': 5}):
        ...
        self.translator.min_sentences = self.opt.min_sentences
...
def main():
    ...
    # reply = model.translate([text_in],
    #                         inference_options=inference_options,
    #                         partial_decode=[" ".join(['<t>', 'nasa', 'scientists', 'say', 'that', 'much', 'of', 'this', 'water', 'loss', 'happened', 'over', 'billions', 'of', 'years', ',', 'along', 'with', 'a', 'loss', 'of', 'atmosphere', '.', '</t>', '<t>', 'nasa', 'scientists', 'say', 'that', 'much', 'of', 'this', 'water', 'loss', 'happened', 'over', 'billions', 'of', 'years', ',', 'along', 'with', 'a', 'loss', 'of', 'atmosphere', '.', '</t>'])])
    # print_only_pred_text(reply)
